...
async function shareBookmark(btn) {
  ...
  try {
    ...
    setTimeout(() => {
      ...
      btn.innerHTML = `<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M13.5 2.5l-7 7M13.5 2.5H9M13.5 2.5V7"/><path d="M6.5 3.5H3a1 1 0 0 0-1 1v8.5a1 1 0 0 0 1 1h8.5a1 1 0 0 0 1-1V10"/></svg>`;
    }, 1500);
  } catch {
